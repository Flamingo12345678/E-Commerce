        ...
        try:
            ...
            if not firebase_admin._apps:
                ...
                if cred_path and os.path.exists(cred_path):
                    ...
                    logger.info(
                        "Firebase initialisé avec le fichier de service account"
                    )
    ...
    def get_or_create_user(self, decoded_token: Dict[str, Any]) -> Optional[User]:
        ...
        try:
            ...
            user_data = {
                ...
                "first_name": (
                    decoded_token.get("name", "").split(" ")[0]
                ...
                "last_name": (
                    ...
                    if decoded_token.get("name")
                    and len(decoded_token.get("name", "").split(" ")) > 1
                    else ""
                ),
                "is_active": True,
            }
...
class FirebaseAuthHelper:
    ...
    def create_custom_token(
        uid: str, additional_claims: Optional[Dict] = None
    ) -> Optional[str]:
        """
